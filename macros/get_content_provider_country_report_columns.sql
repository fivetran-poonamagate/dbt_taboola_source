...
{% macro get_content_provider_country_report_columns() %}
...
{% set columns = [
    ...
    {"name": "country_value", "datatype": dbt.type_string()},
...
{{ fivetran_utils.add_pass_through_columns(columns, var('taboola__content_provider_country_report_passthrough_columns')) }}
